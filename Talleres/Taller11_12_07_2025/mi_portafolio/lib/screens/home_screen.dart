...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Datos de ejemplo para la demostración (puedes personalizar)
    final proyectos = [
      ProyectoData(
        titulo: 'Sistema de Biblioteca',
        descripcion:
            'Aplicación web para gestionar préstamos de libros, registro de usuarios y catálogo digital. Incluye control de inventario y panel administrativo.',
      ...
      ProyectoData(
        ...
        descripcion:
            'Aplicación móvil para gestionar tareas diarias con recordatorios, categorías y búsqueda rápida. Soporta modo offline.',
      ...
      ProyectoData(
        titulo: 'E-commerce',
        descripcion:
            'Tienda virtual con carrito de compras, pasarela de pagos y seguimiento de pedidos. Panel de administración para gestionar productos.',
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
            // Vista 1: ListView con tarjetas completas (Retos 1–6)
            ListView(
            ...
            // Vista 2: Tarjetas expandibles (Reto 7)
            ListView(
              padding: const EdgeInsets.all(16),
              children: [
                Text(
                ...
                for (final p in proyectos)
                  ProyectoExpandible(
                    ...
                    detalles:
                        'Cambios técnicos: integración de autenticación, manejo de estado, optimización de consultas y caching. Arquitectura limpia con separación de capas.',
                  ),
              ],
            ),
